...
echo("<a href='ajstage.php?id=$id'>Ajouter un stagiaire</a>");
echo("<br><br>");
echo("<a href='supstage.php?id=$id'>Supprimer et archiver un stagiaire</a>");
			?>
...
<table>
<tr>
<th><span class="linkcal"><a href="geststagiaire.php?id=<?php echo $id; ?>&month=<?php echo $monthnb - 1; ?>&year=<?php echo $year; ?>"><<</a></span></th>
