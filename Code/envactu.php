...
$fichier = basename($_FILES['avatar']['name']);
	...
	$re="INSERT INTO actualite values (NULL,'$id',CURRENT_DATE,date('d-m-Y H:i:s'),'$np','$text','$fichier')";
		mysql_query($re);
		if(move_uploaded_file($_FILES['avatar']['tmp_name'], $dossier . $fichier)) //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
		{
		
		}
		header('Location: actualite.php?id='.$id);
...
<table>
<tr>
<th><span class="linkcal"><a href="personnel.php?id=<?php echo $id; ?>&month=<?php echo $monthnb - 1; ?>&year=<?php echo $year; ?>"><<</a></span></th>
