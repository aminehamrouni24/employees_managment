...
$id=$_GET['id'];?>
<?php echo("<form name=fr action='chmdp.php?id=$id' method='POST'>");?>
<table>
<tr><td>Ancien  mot de passe:</td><td><input type=text name=anp></td></tr>
<tr><td>Nouveau nom d'utilisateur:</td><td><input type=text name=log></td></tr>
<tr><td>Nouveau mot de passe:</td><td><input type=text name=p></td></tr>

<tr><td>Confirmer votre nouveau mot de passe:</td><td><input type=text name=cp></td></tr>

<tr><td></td><td><input type=submit value="Changer"></td></tr></table>
</form>
...
<table>
<tr>
<th><span class="linkcal"><a href="mdp.php?id=<?php echo $id; ?>&month=<?php echo $monthnb - 1; ?>&year=<?php echo $year; ?>"><<</a></span></th>
