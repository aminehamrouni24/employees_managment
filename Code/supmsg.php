...
<div id="wrapper">
	...
	<?php $res=mysql_connect('localhost','root',''); $res2=mysql_select_db('gestemploye'); $id=$_GET['id']; $req = "select nom  FROM employe WHERE id  = '$id'"; $res=mysql_query ($req); $nom = mysql_fetch_array($res);   ?>
		<ul>
			...
			<li class="current_page_item"><?php echo ("<a href='messagerie.php?id=$id'>Messagerie</a>"); ?></li>
...
<h3 class="title"><f><?php echo ("<a href='afmsg.php?id=$id'>Lire mes messages</a>"); ?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
$ntable='msg'.$id;
                  ...
                  $reee = "DELETE FROM  $ntable  WHERE id  = '$tt'";
                 if(mysql_query ($reee))
				 {
				 echo("<font color=green>Message supprimé</font>");
				 }
