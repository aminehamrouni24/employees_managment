...
echo("<form name=f action='env.php?id=$id' method='POST'>"); ?>
<center>
<table>
<tr><td>Votre message:</td></tr>
<tr><td><TEXTAREA name="t1" rows=10 COLS=40 > </TEXTAREA></td></tr>
<tr><td>Le destinataire: <select name='nomdest'>
...
<table>
<tr>
<th><span class="linkcal"><a href="envmsg.php?id=<?php echo $id; ?>&month=<?php echo $monthnb - 1; ?>&year=<?php echo $year; ?>"><<</a></span></th>
