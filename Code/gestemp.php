...
echo("<a href='ajemp.php?id=$id'>Ajouter un employé</a>");
echo("<br><br>");
echo("<a href='supemp.php?id=$id'>Supprimer et archiver un employé</a>");
			?>
...
<table>
<tr>
<th><span class="linkcal"><a href="gestemp.php?id=<?php echo $id; ?>&month=<?php echo $monthnb - 1; ?>&year=<?php echo $year; ?>"><<</a></span></th>
