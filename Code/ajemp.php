...
<center>			
			<?php
echo("<form name=p action='ajempb.php?id=$id' method='POST'"); 
?>
<center>
<table>
<tr><td>Nom:</td>     <td><input type=text name=t1></input></td></tr>
<tr><td>Prénom:</td>  <td><input type=text name=t2></input></td></tr>
<tr><td></td>         <td><input type=submit value="ajouter employé"></td></tr>
</table>
</center>
<?php echo("</form>");?>
</center>
...
<table>
<tr>
<th><span class="linkcal"><a href="ajemp.php?id=<?php echo $id; ?>&month=<?php echo $monthnb - 1; ?>&year=<?php echo $year; ?>"><<</a></span></th>
