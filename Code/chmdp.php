...
echo"</font>";
	...
	$dbanp= mysql_fetch_array(mysql_query ("select pass from employe where id='$id'"));

	if($dbanp[0]==$anp)
		{
			if($p==$cp)
			{
			$reqp="UPDATE employe SET   pass='$p', login='$log' where id='$id'";
			mysql_query ($reqp);								
			...
			echo"</font>";			
				...
				{
				echo"<font color=red>";
				echo("Veuillez confirmer correctement votre nouveau mot de passe");
				echo"</font>";
				}
