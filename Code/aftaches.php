...
echo("<table><tr><td>");
echo(stripslashes($donnees_messages['heure']));?></td><td></td></tr><tr><td><?php
echo("Envoyé par: </td><td><font color=green>".stripslashes($donnees_messages['nom'])." </font");?></td></tr>
<tr><td><?php echo("Type: </td><td><font color=black>".stripslashes($donnees_messages['type'])." </font");?></td></tr>
<tr><td><?php echo("Commentaire: </td><td bgcolor='white'><font color=black>".stripslashes($donnees_messages['com'])." </font");?></td></tr>
<tr><td><?php 
$xxx=stripslashes($donnees_messages['fich']);

echo("Document attaché:</td><td> <a href='taches/$xxx'>$xxx</a> ");?></td></tr>
<tr><td><?php echo("A faire avant le:</td><td><font color=black>".stripslashes($donnees_messages['dfin'])." </font>");?></td></tr><?php

 echo("<tr><td><a href='suptaches.php?id=$id&t=$ggg'><img src='images/supp.jpg' title='Supprimer cette tâche'></a>  </td></tr>");
echo("</table>");
...
for($i=1; $i<=$nombreDePages; $i++) //On fait notre boucle
{
     ...
     {
          echo ' <a href="aftaches.php?page='.$i.'&id='.$id.'">'.$i.'</a> ';
     }
}
echo '</p>';			
...
<table>
<tr>
<th><span class="linkcal"><a href="aftaches.php?id=<?php echo $id; ?>&month=<?php echo $monthnb - 1; ?>&year=<?php echo $year; ?>"><<</a></span></th>
