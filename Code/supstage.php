...
$requet="SELECT id,nom,prenom FROM stagiaire";
$result = mysql_query($requet);
 echo("<form name=f action='supstageb.php?id=$id' method='POST'>"); ?>
<center>
<table>
...
<table>
<tr>
<th><span class="linkcal"><a href="supstage.php?id=<?php echo $id; ?>&month=<?php echo $monthnb - 1; ?>&year=<?php echo $year; ?>"><<</a></span></th>
