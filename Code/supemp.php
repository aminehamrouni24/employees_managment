...
$requet="SELECT id,nom,prenom FROM employe where id<>1";
$result = mysql_query($requet);
 echo("<form name=f action='supempp.php?id=$id' method='POST'>"); ?>
<center>
<table>
<tr><td>Sélectionnez l'employé à supprimer</td><td> <select name='nomdest' style="width:14em">
...
<tr><td>Raison de départ:</td><td> <select name='nomdep' style="width:14em">
<option value='0'></option>
...
<td>Autre:</td><td><input type=text name=t1 size="25"></td></tr>
<tr><td>Date de départ:</td><td><input type=text name=t2 size="25"></td></tr>
...
<table>
<tr>
<th><span class="linkcal"><a href="supemp.php?id=<?php echo $id; ?>&month=<?php echo $monthnb - 1; ?>&year=<?php echo $year; ?>"><<</a></span></th>
